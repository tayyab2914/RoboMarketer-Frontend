...
DOMAIN_NAME = PRODUCTION
  ? "https://robomarketer.studentspace.website"
  : "http://127.0.0.1:8000";
REDIRECT_URI = PRODUCTION
  ? "https://studentspace.online/account"
  : "http://localhost:3000/account";
FRONTEND_DOMAIN_NAME = PRODUCTION
  ? "https://robo-marketer-frontend.vercel.app/"
  : "http://localhost:3000";
...
export const AI_MODELS = {
  ...
  xAI: {
    icon: "ai_model_x",
    models: [{ name: "Grok-2", value: "grok-2-latest" }],
  },
};
