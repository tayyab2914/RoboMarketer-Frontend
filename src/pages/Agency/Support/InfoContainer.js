        ...
        <div className="info-wrapper">
            ...
            <>
             ...
             <h2 className="section-title">2. Description of Services</h2>
              ...
              <p className="section-text">
                ...
                to access and use RoboMarketer for your business purposes. You
                may not:
              </p>

              <ul className="info-list">
                <li>
                  Copy, distribute, or modify any part of the Service without
                  permission.
                </li>
                <li>
                  Use our trademarks, logos, or other intellectual property
              ...
              <p className="section-text">
                You retain ownership of any content you upload or input into
                RoboMarketer ("User Content"). By using the Service, you grant
                us a worldwide, royalty-free license to use, store, and display
                your User Content for the purpose of providing the Service.
              </p>
          ...
          {dataType == "terms-of-service" && (
            <>
              ...
              <p className="section-text">
                By accessing or using RoboMarketer ("we," "us," "our," or "the
                Service"), you agree to these Terms of Service ("Terms"). If you
                do not agree to these Terms, you may not use the Service. These
                Terms form a binding agreement between you and RoboMarketer.
              </p>

              <h2 className="section-title">2. Description of Services</h2>

              <p className="section-text">
                RoboMarketer provides marketing automation tools, including
                AI-based ad campaign setup, management, and optimization for
                platforms such as Facebook Ads, Google Ads, and other integrated
                APIs ("Services"). We may update or improve the Services from
              ...
              <p className="section-text">
                You must be at least 18 years of age to use RoboMarketer. By
                using the Services, you represent and warrant that: You have the
                authority to enter into these Terms.You will use the Service in
