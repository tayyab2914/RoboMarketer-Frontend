...
import { API_FETCH_TOKEN, API_GET_HISTORICAL_DATA, API_SELECT_ACCOUNT } from "../../../apis/FacebookInsightsApis";
    ...
    const handleAccountClick = async () => {
      if (selectedAccount) {
        ...
        if (response) {
          ...
          dispatch(setCurrentAccount((prevState) => ({ ...prevState, is_facebook_connected: false, })));
        ...
        <div className="custom-modal-content modal-content">
          <Row style={{ width: "100%" }}>
            <Col xs={24} sm={24} md={24} lg={24} style={{ display: "flex", width: "100%" }} >
              ...
              <div className="account-setup-component_content">
                {AccountList ? (
                  <>
